...
if($invoke){
  ...
  exit;
   ...
   print "Generating lsf file \n";
           ...
           print OUT "\ndate\n";
           print OUT "$inch --reads $work_dir/$both_fa --coverage_outfile $work_dir/kmer2iwContig.coverage --run_inchworm --monitor 1 2>$work_dir/monitor.out  >$work_dir/inchworm.K25L48.fa.tmp\n";
  ...
  open(OUT,">$work_dir/$job_name".'.lsf');
   ...
   print "Generating lsf file \n";
           ...
           print OUT "$inch --kmers $work_dir/meryl.kmers.min${min_kmer_coverage}.fa --coverage_outfile $work_dir/kmer2iwContig.coverage --run_inchworm --monitor 1 2>$work_dir/monitor.out  >$work_dir/inchworm.K25L48.fa.tmp  \n";
